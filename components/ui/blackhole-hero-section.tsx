...
/* -------------------------------------------------------------------------- */
/*  Locked component — supplied in about_section.md.                          */
/*                                                                            */
/*  A raymarched black hole: one ray per pixel, integrated backwards through  */
/*  Schwarzschild curved space. The engine below (shaders, render targets,    */
/*  the render loop, and all prop plumbing) is integrated verbatim. The only  */
/*  additions are this provenance header and the "use client" directive       */
